...
homepage: "[https://www.yeogi.com](https://www.yeogi.com)"
...
logo:
  ...
  slug: "[https://www.google.com/s2/favicons?domain=yeogi.com&amp;sz=128](https://www.google.com/s2/favicons?domain=yeogi.com&sz=128)"
...
ds:
  ...
  url: "[https://designlibrary.yeogi.com/](https://designlibrary.yeogi.com/)"

  type: system

  description: "YDS 6.0 foundations and public Button, Price marker, Search bar component guidance."

  og_image: "[https://framerusercontent.com/assets/kA6JROOLbG0jX7SQZl1tLZzahM.jpg](https://framerusercontent.com/assets/kA6JROOLbG0jX7SQZl1tLZzahM.jpg)"
...
verification_v2:
  ...
  surfaces:
    ...
    - { id: home, kind: product, url: "[https://www.yeogi.com/](https://www.yeogi.com/)", inspected: "2026-07-11" }

    - { id: results, kind: product, url: "[https://www.yeogi.com/domestic-accommodations](https://www.yeogi.com/domestic-accommodations)", inspected: "2026-07-11" }

    - { id: ds-home, kind: design-system, url: "[https://designlibrary.yeogi.com/](https://designlibrary.yeogi.com/)", inspected: "2026-07-11" }

    - { id: colors, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/color/palette-color](https://designlibrary.yeogi.com/foudations/color/palette-color)", inspected: "2026-07-11" }

    - { id: typography, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/typography](https://designlibrary.yeogi.com/foudations/typography)", inspected: "2026-07-11" }

    - { id: layout, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/layout](https://designlibrary.yeogi.com/foudations/layout)", inspected: "2026-07-11" }

    - { id: radius, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/radius](https://designlibrary.yeogi.com/foudations/radius)", inspected: "2026-07-11" }

    - { id: components, kind: design-system, url: "[https://designlibrary.yeogi.com/components/overview](https://designlibrary.yeogi.com/components/overview)", inspected: "2026-07-11" }

    - { id: shadow, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/shadow](https://designlibrary.yeogi.com/foudations/shadow)", inspected: "2026-07-11" }

    - { id: spacing, kind: design-system, url: "[https://designlibrary.yeogi.com/foudations/spacing](https://designlibrary.yeogi.com/foudations/spacing)", inspected: "2026-07-11" }

  sources:

    - { id: product-live, kind: product-surface, url: "[https://www.yeogi.com/](https://www.yeogi.com/)", captured: "2026-07-11" }

    - { id: results-live, kind: product-surface, url: "[https://www.yeogi.com/domestic-accommodations](https://www.yeogi.com/domestic-accommodations)", captured: "2026-07-11" }

    - { id: ds-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/](https://designlibrary.yeogi.com/)", captured: "2026-07-11" }

    - { id: colors-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/color/palette-color](https://designlibrary.yeogi.com/foudations/color/palette-color)", captured: "2026-07-11" }

    - { id: typography-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/typography](https://designlibrary.yeogi.com/foudations/typography)", captured: "2026-07-11" }

    - { id: layout-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/layout](https://designlibrary.yeogi.com/foudations/layout)", captured: "2026-07-11" }

    - { id: radius-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/radius](https://designlibrary.yeogi.com/foudations/radius)", captured: "2026-07-11" }

    - { id: components-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/components/overview](https://designlibrary.yeogi.com/components/overview)", captured: "2026-07-11" }

    - { id: shadow-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/shadow](https://designlibrary.yeogi.com/foudations/shadow)", captured: "2026-07-11" }

    - { id: spacing-doc, kind: official-doc, url: "[https://designlibrary.yeogi.com/foudations/spacing](https://designlibrary.yeogi.com/foudations/spacing)", captured: "2026-07-11" }
  ...
  claims:
    ...
    "[tokens.colors.red](http://tokens.colors.red)": *color

    "[tokens.colors.red](http://tokens.colors.red)-tint": *color

    "[tokens.colors.blue](http://tokens.colors.blue)-tint": *color

    "tokens.colors.yellow": *color

    "tokens.colors.slate": *color

    "[tokens.typography.family](http://tokens.typography.family).sans": &amp;type { surface_id: typography, source_id: typography-doc, method: official-doc+live-inspect, captured: "2026-07-11" }
    ...
    "[tokens.spacing.sm](http://tokens.spacing.sm)": *space

    "[tokens.spacing.md](http://tokens.spacing.md)": *space
    ...
    "[tokens.rounded.sm](http://tokens.rounded.sm)": *radius

    "[tokens.rounded.md](http://tokens.rounded.md)": *radius
    ...
    "[tokens.components.button.bg](http://tokens.components.button.bg)": *color
    ...
    "[tokens.components.search](http://tokens.components.search)-bar.type": *component

    "[tokens.components.search-bar.bg](http://tokens.components.search-bar.bg)": *component

    "[tokens.components.search](http://tokens.components.search)-bar.fg": *component

    "[tokens.components.search](http://tokens.components.search)-bar.radius": *component

    "[tokens.components.search](http://tokens.components.search)-bar.states": *component

    "[tokens.components.search](http://tokens.components.search)-bar.use": *component

    "tokens.components.price-marker.type": *component

    "[tokens.components.price-marker.bg](http://tokens.components.price-marker.bg)": *component
    ...
    "[tokens.components.filter-chip.bg](http://tokens.components.filter-chip.bg)": *results
    ...
    "[tokens.components.listing-card.bg](http://tokens.components.listing-card.bg)": *results
...
**Tier 1 sources:** [https://www.yeogi.com/](https://www.yeogi.com/) , [https://www.yeogi.com/domestic-accommodations](https://www.yeogi.com/domestic-accommodations) , [https://designlibrary.yeogi.com/](https://designlibrary.yeogi.com/) , [https://designlibrary.yeogi.com/foudations/color/palette-color](https://designlibrary.yeogi.com/foudations/color/palette-color) , [https://designlibrary.yeogi.com/foudations/typography](https://designlibrary.yeogi.com/foudations/typography) , [https://designlibrary.yeogi.com/foudations/layout](https://designlibrary.yeogi.com/foudations/layout) , [https://designlibrary.yeogi.com/foudations/radius](https://designlibrary.yeogi.com/foudations/radius) , [https://designlibrary.yeogi.com/components/overview](https://designlibrary.yeogi.com/components/overview)
